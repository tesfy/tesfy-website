...
The format to define audiences is [jsonLogic](http://jsonlogic.com/) which allow you to build complex rules as JSON. For example, you can nest rules to target users that are older than 32 years old and are located in Venezuela.
